# ngx-admin with alternative grid integration
Showcases in this project :
* ag-grid (module integration)
* Primeng grid (module and style integration)

![assets/ag-grid.png](assets/ag-grid.png)
